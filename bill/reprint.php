<?php
 ...
 include "db.php";
 $iv=$_POST['iv'];
 $sql0="SELECT * FROM purchestotal WHERE `invoicenumber`='$iv'";
 $run0=mysqli_query($con,$sql0);
 $row0=mysqli_fetch_assoc($run0);

 $bill=$row0['bill'];
 $ship=$row0['ship'];
 $invoicenumber=$row0['invoicenumber'];
 $invoicedate=$row0['invoicedate'];
 $payment=$row0['payment']; 
 //echo "$bill\n$ship\n $invoicenumber\n $invoicedate\n $payment ";
?>	
    ...
    <script type="text/javascript">
    	$(document).ready(function(){  
            ...
            $("#cancel").hide();
             	window.print();
           		/*
           		$.post("master.php",{status:"ok" },function(){
        ...
        <tr>
  		...
  		<div class="w3-col m5">
  			<table class="w3-table" id="tbl">  	
  				...
  				<?php 
  				  $bill1="SELECT * FROM `billing` WHERE `name`='$bill'";
                  $run=mysqli_query($con,$bill1);
          ...
          <tr><td></td><td><h5 >Shipping Address</h5></td></tr>
  			<?php
  			      ...
  			      $ship1="SELECT * FROM `billing` WHERE `name`='$ship'";
                  $run2=mysqli_query($con,$ship1);
                  ...
                  */
                   ...
                   echo "
                        <tr>
		  				...
		  				<tr>
		  					<td>Date</td><td>".$invoicedate."</td>
		  				</tr>
		  				<tr id='iv'>
		  					<td id='ipad'>Payment</td><td>".$payment."</td>
		  				</tr>
  	...
  	<div class="w3-col m12" >
  		...
  		<table class="w3-table" id="tab">
  			...
  			<?php 
				 ...
				 $query2="SELECT * FROM `purches` WHERE `invoiceno`='$invoicenumber'";
				 $run3=mysqli_query($con,$query2);
				  ...
				  while($row3=mysqli_fetch_assoc($run3)){ 
                    ...
                    $tamount=$row3['quantity']*$row3['rate'];
                    $gst=($tamount*$row3['gst'])/100;
